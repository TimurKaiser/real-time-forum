...
export function LoadUserTemplate() {
  ...
  button_publicProfile.addEventListener("click", LoadUserPublicTemplate);
  button_userModif.addEventListener("click", LoadUserModifInfoTemplate);

  //   const data = {
  //     token: cookie, // replace with the actual token value
  //   };
